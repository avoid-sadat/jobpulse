...
class HomeController extends Controller
{
    ...
    {
        $category= Job::with('category')->get();
        ...
        $jobs = Job::all();
            ...
            return view('user.home',compact('totaljobs','totalusers','jobs','acceptedApplications','category'));
    ...
    public function jobs(){
        ...
        $jobs = Job::all();
        return view('user.jobs',compact('totaljobs', 'totalusers','jobs','acceptedApplications','category'));
    }
