        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              ...
              <p>Are you ready to turn your dreams into reality? Discover the easiest and most efficient way to secure your dream job with JobPulse.</p>
            </div>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2 text-white">JobPulse Site Stats</h2>
            <p class="lead text-white">Discover the power of JobPulse's site statistics. Our platform is a hub of endless opportunities, providing a seamless experience for job seekers and employers alike</p>
          </div>
        </div>
