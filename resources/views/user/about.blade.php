      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="section-title mb-3">Company History</h2>
            <p class="lead">Are you a talented web developer looking to take your freelance career to new heights? Look no further than JobPulse, the ultimate platform for freelance web developers!</p>
            <p>At JobPulse, we understand the unique needs of freelancers like you, and we've curated a marketplace that connects you with top-notch clients from around the world. Showcase your skills, expertise, and portfolio on our platform, and let the opportunities come to you.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            ...
            <p class="lead">
Are you ready to take your career to the next level? Welcome to JobPulse, the ultimate platform for workers seeking exciting job opportunities and career growth!</p>
            <p>At JobPulse, we understand that finding the perfect job can be a daunting task. That's why we've created a user-friendly and intuitive platform that connects you with top employers from various industries. Whether you're an experienced professional or just starting your journey, JobPulse has something for everyone.</p>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="col-12 text-center mt-4 mb-5">
                  <div class="row justify-content-center">
                      <div class="col-md-7">
                          ...
                          <p class="lead">Over the years, JobPulse has been instrumental in connecting talented individuals with leading companies worldwide.</p>
                      </div>
                  </div>
